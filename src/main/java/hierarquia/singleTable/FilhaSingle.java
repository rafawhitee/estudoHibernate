...
@Entity
@DiscriminatorValue(value = "FILHA") // Para diferenciar no Banco de dados qual o tipo daquela Linha (o Hibernate cria uma Coluna DType para colocar esse valor)
public class FilhaSingle extends PaiSingle {
	...
	private String atributoSomenteDoFilhaSingle;
	
	public FilhaSingle() {
		super();
	}

	public String getAtributoSomenteDoFilhaSingle() {
		return atributoSomenteDoFilhaSingle;
	}

	public void setAtributoSomenteDoFilhaSingle(String atributoSomenteDoFilhaSingle) {
		this.atributoSomenteDoFilhaSingle = atributoSomenteDoFilhaSingle;
	}
